...
export default function ViewAttendence({ checked }) {
                ...
                <div>
                    <div >
                        <table className={classes.table}>
                            <tr>
                                <td className={classes.tablehead} align="center" style={{ color: checked ? '#fff' : '#20213D' }} >No.</td>
                                <td className={classes.tablehead} align="center" style={{ color: checked ? '#fff' : '#20213D' }} >Roll Number</td>
                                <td className={classes.tablehead} align="center" style={{ color: checked ? '#fff' : '#20213D' }} >Name</td>
                                <td className={classes.tablehead} align="center" style={{ color: checked ? '#fff' : '#20213D' }} >Present / Absent</td>
                                <td className={classes.tablehead} align="center" style={{ color: checked ? '#fff' : '#20213D' }} >Present / Absent</td>
                                <td className={classes.tablehead} align="center" style={{ color: checked ? '#fff' : '#20213D' }} >Present / Absent</td>
                                <td className={classes.tablehead} align="center" style={{ color: checked ? '#fff' : '#20213D' }} >Present / Absent</td>
                                <td className={classes.tablehead} align="center" style={{ color: checked ? '#fff' : '#20213D' }} >Present / Absent</td>
                            ...
                            <tr className={!checked ? classes.tablerow : classes.darktablerow} >
                                <td className={classes.tabledata} align="center" style={{ color: checked ? '#fff' : '#20213D' }}>01</td>
